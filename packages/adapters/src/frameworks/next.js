...
export function installPhantomCSS(options = {}) {
  return createFrameworkAdapter('next', options);
}

export function exportPhantomNextDocs(options = {}) {
...
export const phantomNextAdapter = installPhantomCSS;
export const phantomNextDocs = exportPhantomNextDocs;

export default phantomNextAdapter;
